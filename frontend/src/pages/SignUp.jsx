        ...
        <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-8 py-12">
          <div className="max-w-md mx-auto w-full">
            ...
            >
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-orange-400/10 to-amber-400/10 rounded-2xl blur-sm group-hover:blur-md transition-all duration-300 opacity-0 group-hover:opacity-100" />
              ...
              >
                ...
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-12 py-4 bg-white/70 backdrop-blur-md rounded-2xl border border-white/20 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-orange-300/50 text-orange-900 placeholder-orange-700/80 transition-all duration-300 hover:bg-white/15 focus:bg-white/20"
                    required
                  />
                  <motion.button
                    type="button"
